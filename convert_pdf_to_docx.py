...
def process_job(ch, method, data):
    ...
    try:
        ...
        logger.info("Converting PDF → DOCX")
...
def main():
    ...
    channel.basic_consume(queue="pdf-conversion-queue", on_message_callback=callback, auto_ack=False)
    ...
    def shutdown(sig, frame):
        ...
        # Do NOT call connection.close() here — let start_consuming() exit first
